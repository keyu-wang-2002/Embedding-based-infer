    ...
    public static void printAxiomInfo(OWLAxiom a, String str) {
        ...
        if (a instanceof OWLSubClassOfAxiom) {
            ...
            if (a instanceof OWLObjectPropertyDomainAxiom) {
                ...
                System.out.print(opInRangeAxiom.toString() + "\thasDomainIn\t");
                printConcept(range, str);
                //Our own transformation rules
                ...
                OWLClassExpression range = domainAxiom.getDomain();
                System.out.print(opInDomainAxiom.toString() + "\thasDomainIn\t");
                printConcept(range, str);
                //Our own transformation rules
                ...
                System.out.print(opInRangeAxiom.toString() + "\trangeIn\t");
                printConcept(range, str);
                //Our own transformation rules
            } else if (a instanceof OWLDataPropertyRangeAxiom) {
                OWLDataPropertyRangeAxiom rangeAxiom = (OWLDataPropertyRangeAxiom) a;
                System.out.print(((OWLDataPropertyExpression) rangeAxiom.getProperty()).toString() + "\trangeIn\t" + ((OWLDataRange) rangeAxiom.getRange()).toString());
            } //NatrualOWL
                ...
                for (Iterator var5 = ax.getClassExpressions().iterator(); var5.hasNext(); ++counter) {
                    ...
                    if (counter < size) {
                        System.out.print("\tisEquivalentTo\t");
                    }
                }
            }//Our own transformation rules
            ...
            //Our own transformation rules
                ...
                System.out.print(subPr.toString() + "\tisSubpropertyOf\t" + supPr.toString());
            }
            //Our own transformation rules
            else if (a instanceof OWLClassAssertionAxiom) {
                OWLClassAssertionAxiom ax = (OWLClassAssertionAxiom) a;
                System.out.print(ax.getIndividual().toString() + "\tbelongsTo\t");
                ...
                System.out.print(ax.getObject().toString() + "\tbelongsTo\t");
                ...
                System.out.print(ax.getFirstProperty().toString() + "\tisReverseTo\t");
