...
with open('./embed/transe_UOBM35_embed.vec','r',encoding='utf8') as fp:
...
print("rescal, Cosine Similarity ")
...
cnt = 1
for Ki in mc_K:
    print("Method 2 K{0}  score: {1}".format(cnt, score_all(Ki)))
    cnt += 1
end2 = time.time()
...
cnt = 1
for Ki in mc_K:
    print("Method 4 K{0}  score: {1}".format(cnt, score_local(Ki)))
    cnt += 1
end3 = time.time()
...
end4 = time.time()
print("euc cal time {0}".format(end4 - start4))
print("\n\nrescal, Euclidean Similarity")
