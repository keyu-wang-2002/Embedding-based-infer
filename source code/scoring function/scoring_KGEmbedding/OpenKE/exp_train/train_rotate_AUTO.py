...
trainer.run()
rotate.save_checkpoint('./checkpoint/rotate_AUTO.ckpt')

rotate.save_parameters('./embed/rotate_AUTO_embed.vec')  # 保存嵌入向量

# test the model
rotate.load_checkpoint('./checkpoint/rotate_AUTO.ckpt')
