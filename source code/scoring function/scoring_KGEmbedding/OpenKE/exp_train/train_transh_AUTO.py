...
trainer.run()
transh.save_checkpoint('./checkpoint/transh_AUTO.ckpt')

transh.save_parameters('./embed/transh_AUTO_embed.vec') # 保存嵌入向量

# test the model
transh.load_checkpoint('./checkpoint/transh_AUTO.ckpt')
