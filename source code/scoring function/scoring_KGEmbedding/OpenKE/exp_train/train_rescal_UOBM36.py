...
trainer.run()
rescal.save_checkpoint('./checkpoint/rescal_UOBM36.ckpt')

rescal.save_parameters('./embed/rescal_UOBM36_embed.vec')  # 保存嵌入向量

# test the model
rescal.load_checkpoint('./checkpoint/rescal_UOBM36.ckpt')
