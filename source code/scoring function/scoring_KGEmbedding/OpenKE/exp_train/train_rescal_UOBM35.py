...
trainer.run()
rescal.save_checkpoint('./checkpoint/rescal_UOBM35.ckpt')

rescal.save_parameters('./embed/rescal_UOBM35_embed.vec')  # 保存嵌入向量

# test the model
rescal.load_checkpoint('./checkpoint/rescal_UOBM35.ckpt')
