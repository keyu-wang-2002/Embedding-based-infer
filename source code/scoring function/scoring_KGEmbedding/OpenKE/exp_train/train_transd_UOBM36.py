...
trainer.run()
transd.save_checkpoint('./checkpoint/transd_UOBM36.ckpt')

transd.save_parameters('./embed/transd_UOBM36_embed.vec') # 保存嵌入向量

# test the model
transd.load_checkpoint('./checkpoint/transd_UOBM36.ckpt')
